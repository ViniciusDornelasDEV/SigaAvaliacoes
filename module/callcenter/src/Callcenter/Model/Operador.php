...
class Operador Extends BaseTable {
    ...
    public function getAvaliacoesNaoRespondidas($data){
        ...
        $sql = 'SELECT co.*, c.*, pa.data_referencia, e.nome_empresa
                ...
                LEFT JOIN tb_callcenter AS c ON c.usuario = u.id
                INNER JOIN tb_pilha_avaliacoes_callcenter AS pa ON "'.$data.'" BETWEEN pa.inicio AND pa.termino
