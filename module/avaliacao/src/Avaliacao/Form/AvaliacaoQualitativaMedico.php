<?php
 ...
 class AvaliacaoQualitativaMedico extends BaseForm {
   ...
   public function __construct($name, $serviceLocator, $campos)
    {
        ...
        if($campos['qualidade']['aparecer'] == 'S'){
            ...
            $opcoes = $serviceOpcoes->prepareForDropDown($opcoes, array('id', 'opcao'));

            $obrigatorio = $this->booleanByAtivo($campos['qualidade']['obrigatorio']);
            $this->_addDropdown('qualidade', $obrigatorio['prefixo'].$campos['qualidade']['label'], $obrigatorio['obrigatorio'], $opcoes);
        ...
        if($campos['relacionamento_comunidade']['aparecer'] == 'S'){
            ...
            $this->_addDropdown('relacionamento_comunidade', $obrigatorio['prefixo'].$campos['relacionamento_comunidade']['label'], $obrigatorio['obrigatorio'], $opcoes);
        ...
        if($campos['difusao_conhecimento']['aparecer'] == 'S'){
            ...
            $this->_addDropdown('difusao_conhecimento', $obrigatorio['prefixo'].$campos['difusao_conhecimento']['label'], $obrigatorio['obrigatorio'], $opcoes);
        ...
        if($campos['relacionamento_interno']['aparecer'] == 'S'){
            ...
            $this->_addDropdown('relacionamento_interno', $obrigatorio['prefixo'].$campos['relacionamento_interno']['label'], $obrigatorio['obrigatorio'], $opcoes);
        ...
        if($campos['producao_cientifica']['aparecer'] == 'S'){
            ...
            $this->_addDropdown('producao_cientifica', $obrigatorio['prefixo'].$campos['producao_cientifica']['label'], $obrigatorio['obrigatorio'], $opcoes);
