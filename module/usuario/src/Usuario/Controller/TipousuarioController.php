...
class TipousuarioController extends AbstractActionController
{
    ...
    private function redirecionar($tipoUsuario, $recurso = false){
        if($recurso){
            ...
            return $this->redirect()->toRoute('tipousuarioAlterar', array('id' => $tipoUsuario));
        }
    }
