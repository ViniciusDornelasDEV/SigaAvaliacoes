...
abstract class Base extends Form {
     ...
     * @return BaseForm
     */
    public function addSubmit($label = 'Submit', $class = 'btn btn-success', $style = 'float: right;margin-right: 10px;') {
        /*   $this->add(array(
     ...
     * @return void
     */
    protected function genericTextInput($name, $label = false, $required = true, $placeholder = false, $function = '', $style = '') {
    ...
    protected function textInputCpf($name, $label, $required, $placeholder) {
    ...
    protected function _addGenericDateElement($name, $label = false, $required = true) {
        ...
        $this->inputFilterArray[$name] = array('name'=>$name, 'required'=>$required);
    ...
    public function integerNumberInput($name, $label, $required = false, $attrs = false) {
        if(!$attrs){
            $attrs = array('class' => 'form-control', 'style' => 'max-width: 100px;', 'required' => $required); 
            $attrs['id'] = $name;
        }
    ...
    public function gerarPergunta($nomeCombo, $labelCombo, $nomeChave, $arrayCombo, $required = true){
        $this->_addDropdown($nomeCombo, $labelCombo, $required, $arrayCombo);

        $this->genericTextInput('observacoes_'.$nomeChave, '', false, 'Observações');

        $this->addImageFileInput('anexo_'.$nomeChave, '', false);
    }

    public function prepararCamposDinamicos($campos){
        $aux = array();
